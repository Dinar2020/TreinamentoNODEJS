console.log("----Expressão de Comparação----");
...
console.log("x é igual a z (comparação entre valores e tipos de dados)?" + (x === z));
console.log("x é diferente de z (comparação entre valores)?" + (x !=z));
console.log("x é diferente de z (comparação entre valores e tipos de dados)?" + (x !==z));
